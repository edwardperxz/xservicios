  ...
  <style>
    * {
    ...
    .hero {
      position: relative;
      height: 480px;
      background: url('<?= $this->Url->image("login-bg.jpeg") ?>') center/cover no-repeat;
      display: flex;
      align-items: center;
      padding: 0 3rem;
    }
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      <h1 class="hero-title">Transporte turistico de lujo en Chiriqui</h1>
  ...
  <section class="tabs-section">
    ...
    <div class="content-card">
      ...
      <div class="ver-mas-container">
        <a class="btn-ver-mas" href="/myreservations">Ver Mas</a>
      </div>
    </div>
  </section>

  <?= $this->Html->script('header-template') ?>
  ...
  <script>
    ...
    const cargarHomeLogin = async () => {
      try {
        ...
        console.error('Error cargando home-login:', error);
      }
    };
