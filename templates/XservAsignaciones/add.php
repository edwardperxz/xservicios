...
$this->assign('header-title', 'Nueva Asignación');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Nueva Asignación</h2>
            <p class="form-subtitle">Asigne chofer y vehículo a una reserva</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Asignación', ['class' => 'btn btn-primary']) ?>
        </div>
