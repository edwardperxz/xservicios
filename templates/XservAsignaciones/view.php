<?php
$this->assign('header-title', 'Detalle de Asignación');
?>
...
<div class="view-container">
    <div class="view-card">
        <div class="view-header">
            <h2 class="view-title">Asignación #<?= h($xservAsignacione->id) ?></h2>
            <div class="view-actions">
                <a href="<?= $this->Url->build(['action' => 'edit', $xservAsignacione->id]) ?>" class="btn btn-primary">Editar</a>
                <a href="<?= $this->Url->build(['action' => 'index']) ?>" class="btn btn-secondary">Volver al Listado</a>
                <?= $this->Form->postLink('Eliminar', ['action' => 'delete', $xservAsignacione->id], ['confirm' => '¿Está seguro?', 'class' => 'btn btn-danger']) ?>
            </div>
        </div>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value"><?= $xservAsignacione->hasValue('reserva') ? $this->Html->link($xservAsignacione->reserva->codigo_reserva, ['controller' => 'XservReservas', 'action' => 'view', $xservAsignacione->reserva->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value"><?= $xservAsignacione->hasValue('vehiculo') ? $this->Html->link($xservAsignacione->vehiculo->tipo, ['controller' => 'XservVehiculos', 'action' => 'view', $xservAsignacione->vehiculo->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Asignado Por</div>
                <div class="detail-value"><?= $xservAsignacione->hasValue('asignado_por') ? $this->Html->link($xservAsignacione->asignado_por->username, ['controller' => 'XservUsuarios', 'action' => 'view', $xservAsignacione->asignado_por->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Estado Asignación</div>
                <div class="detail-value"><?= h($xservAsignacione->estado_asignacion) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Fecha Inicio Pactada</div>
                <div class="detail-value"><?= h($xservAsignacione->fecha_inicio_pactada) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Fecha Fin Pactada</div>
                <div class="detail-value"><?= h($xservAsignacione->fecha_fin_pactada) ?></div>
            </div>
            <div class="detail-item" style="grid-column: 1 / -1;">
                <div class="detail-label">Observaciones Chofer</div>
                <div class="detail-value"><?= h($xservAsignacione->observaciones_chofer) ?></div>
            </div>
        </div>
    </div>
</div>