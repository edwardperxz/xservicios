...
<style>
    :root { --gold: #c9a962; --gold-light: #d4b978; --dark-bg: #0a0a0a; --dark-card: #1a1a1a; --dark-lighter: #2a2a2a; --text-white: #ffffff; --text-gray: #a0a0a0; --red: #ef4444; }
    ...
    .btn-danger { background: var(--red); color: var(--text-white); }
    .btn-danger:hover { background: #dc2626; }
    .delete-section { margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--dark-lighter); }
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Modifique la información del chofer</p>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <span class="form-help">Usuario vinculado a este chofer</span>
            </div>
            <div class="form-group">
