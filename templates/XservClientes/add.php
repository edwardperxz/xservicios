...
$this->assign('header-title', 'Nuevo Cliente');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Complete el formulario para agregar un nuevo cliente</p>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <?= $this->Form->control('idioma_preferido', ['options' => $idiomaOptions, 'empty' => 'Seleccione idioma', 'class' => 'form-select', 'label' => false]) ?>
                <span class="form-help">Idioma de comunicación</span>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('direccion_facturacion', ['type' => 'textarea', 'class' => 'form-textarea', 'label' => false, 'placeholder' => 'Dirección completa']) ?>
                <span class="form-help">Dirección para facturación</span>
            </div>
        </div>

        <div class="form-actions">
            <a href="<?= $this->Url->build(['action' => 'index']) ?>" class="btn btn-secondary">Cancelar</a>
            <?= $this->Form->button('Guardar Cliente', ['class' => 'btn btn-primary']) ?>
        </div>
