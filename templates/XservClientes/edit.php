...
$this->assign('header-title', 'Editar Cliente');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Modifique los datos del cliente</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Cliente', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
