...
$this->assign('header-title', 'Nueva Configuración');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Agregue un nuevo parámetro de configuración del sistema</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Configuración', ['class' => 'btn btn-primary']) ?>
        </div>
