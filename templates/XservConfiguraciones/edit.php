...
$this->assign('header-title', 'Editar Configuración');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Editar Configuración</h2>
            <p class="form-subtitle">Modifique el parámetro de configuración del sistema</p>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('clave', ['class' => 'form-input', 'label' => false, 'placeholder' => 'ej: tarifa_itbms', 'required' => true]) ?>
                <span class="form-help">Identificador único del parámetro</span>
            </div>
            <div class="form-group">
                <label class="form-label required">Tipo de Dato</label>
                <?= $this->Form->control('tipo_dato', ['options' => $tipoDatoOptions, 'empty' => 'Seleccione un tipo', 'class' => 'form-select', 'label' => false, 'required' => true]) ?>
                <span class="form-help">Tipo de dato del valor</span>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label class="form-label">Editable por Admin</label>
                <?= $this->Form->control('editable_por_admin', ['options' => $editableOptions, 'empty' => 'Seleccione', 'class' => 'form-select', 'label' => false]) ?>
                <span class="form-help">¿Puede ser modificado por admin?</span>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('valor', ['type' => 'textarea', 'class' => 'form-textarea', 'label' => false, 'placeholder' => 'Valor del parámetro', 'required' => true]) ?>
                <span class="form-help">Valor actual del parámetro</span>
            </div>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label class="form-label">Descripción del Parámetro</label>
                <?= $this->Form->control('descripcion_parametro', ['type' => 'textarea', 'class' => 'form-textarea', 'label' => false, 'placeholder' => 'Explique el propósito de este parámetro']) ?>
                <span class="form-help">Documentación del parámetro</span>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Configuración', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
        ...
        <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--dark-lighter, #2a2a2a);">
            <?= $this->Form->postLink(
                ...
                ['confirm' => '¿Está seguro de eliminar esta configuración? Esta acción no se puede deshacer.', 'class' => 'btn btn-danger']
            ) ?>
        </div>
    </div>
</div>
