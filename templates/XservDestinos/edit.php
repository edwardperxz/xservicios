...
$this->assign('header-title', 'Editar Destino');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Modifique los datos del destino turístico</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Destino', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
