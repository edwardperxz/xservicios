...
$this->assign('header-title', 'Nueva Ejecución de Viaje');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Nueva Ejecución de Viaje</h2>
            <p class="form-subtitle">Registre los datos de ejecución del viaje</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Ejecución', ['class' => 'btn btn-primary']) ?>
        </div>
