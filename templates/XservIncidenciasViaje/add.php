...
$this->assign('header-title', 'Nueva Incidencia');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Nueva Incidencia de Viaje</h2>
            <p class="form-subtitle">Registre una incidencia ocurrida durante un viaje</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Incidencia', ['class' => 'btn btn-primary']) ?>
        </div>
