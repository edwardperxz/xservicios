<?php
$this->assign('header-title', 'Detalle de Incidencia de Viaje');
?>
...
<div class="view-container">
    <div class="view-card">
        <div class="view-header">
            <h2 class="view-title">Incidencia: <?= h($xservIncidenciasViaje->tipo_incidencia) ?></h2>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                <div class="detail-label">Ejecución</div>
                <div class="detail-value"><?= $xservIncidenciasViaje->hasValue('ejecucion') ? $this->Html->link('Ejecución #' . $xservIncidenciasViaje->ejecucion->id, ['controller' => 'XservEjecucionViajes', 'action' => 'view', $xservIncidenciasViaje->ejecucion->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Tipo Incidencia</div>
                <div class="detail-value"><?= h($xservIncidenciasViaje->tipo_incidencia) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Severidad</div>
                <div class="detail-value"><?= h($xservIncidenciasViaje->severidad) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Resuelto</div>
                <div class="detail-value"><?= $xservIncidenciasViaje->resuelto ? 'Sí' : 'No' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Latitud Incidencia</div>
                <div class="detail-value"><?= $xservIncidenciasViaje->latitud_incidencia === null ? 'N/A' : $this->Number->format($xservIncidenciasViaje->latitud_incidencia) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Longitud Incidencia</div>
                <div class="detail-value"><?= $xservIncidenciasViaje->longitud_incidencia === null ? 'N/A' : $this->Number->format($xservIncidenciasViaje->longitud_incidencia) ?></div>
            </div>
            <div class="detail-item" style="grid-column: 1 / -1;">
                <div class="detail-label">Descripción</div>
                <div class="detail-value"><?= h($xservIncidenciasViaje->descripcion) ?></div>
            </div>
        </div>
    </div>
</div>
