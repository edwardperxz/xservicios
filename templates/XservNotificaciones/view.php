    ...
    <div class="view-card">
        <div class="view-header">
            ...
            <div class="view-actions">
                ...
                <?= $this->Form->postLink('Eliminar', ['action' => 'delete', $xservNotificacione->id], ['confirm' => '¿Está seguro?', 'class' => 'btn btn-danger']) ?>
            </div>
        </div>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value"><?= $xservNotificacione->hasValue('usuario') ? $this->Html->link($xservNotificacione->usuario->username, ['controller' => 'XservUsuarios', 'action' => 'view', $xservNotificacione->usuario->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Cliente</div>
                <div class="detail-value"><?= $xservNotificacione->hasValue('cliente') ? $this->Html->link($xservNotificacione->cliente->nombre, ['controller' => 'XservClientes', 'action' => 'view', $xservNotificacione->cliente->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Reserva</div>
                <div class="detail-value"><?= $xservNotificacione->hasValue('reserva') ? $this->Html->link($xservNotificacione->reserva->codigo_reserva, ['controller' => 'XservReservas', 'action' => 'view', $xservNotificacione->reserva->id]) : '<span style="color: #6b7280;">No asignado</span>' ?></div>
            </div>
            <div class="detail-item">
