...
$this->assign('header-title', 'Editar Reserva');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Modifique los datos de la reserva de servicio</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Reserva', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
