 ...
 * @var string[]|\Cake\Collection\CollectionInterface $rutas
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $xservReserva->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="xservReservas form content">
            ...
            <fieldset>
                <legend><?= __('Edit Xserv Reserva') ?></legend>
                <?php
