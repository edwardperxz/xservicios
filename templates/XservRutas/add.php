 ...
 */
$this->assign('header-title', 'Nueva Ruta');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Complete el formulario para agregar una nueva ruta de transporte</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Ruta', ['class' => 'btn btn-primary']) ?>
        </div>
