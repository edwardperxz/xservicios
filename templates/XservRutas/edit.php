 ...
 */
$this->assign('header-title', 'Editar Ruta');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Editar Ruta</h2>
            <p class="form-subtitle">Modifique los datos de la ruta de transporte</p>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('origen_id', ['options' => $origens, 'empty' => 'Seleccione origen', 'class' => 'form-select', 'label' => false, 'required' => true]) ?>
                <span class="form-help">Punto de partida</span>
            </div>
            <div class="form-group">
                <label class="form-label required">Destino</label>
                <?= $this->Form->control('destino_id', ['options' => $destinos, 'empty' => 'Seleccione destino', 'class' => 'form-select', 'label' => false, 'required' => true]) ?>
                <span class="form-help">Punto de llegada</span>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <?= $this->Form->control('tiempo_estimado_min', ['type' => 'number', 'min' => 0, 'class' => 'form-input', 'label' => false, 'placeholder' => 'ej: 60']) ?>
                <span class="form-help">Duración aproximada del viaje</span>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Ruta', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
        ...
        <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--dark-lighter, #2a2a2a);">
            <?= $this->Form->postLink(
                ...
                ['confirm' => '¿Está seguro de eliminar esta ruta? Esta acción no se puede deshacer.', 'class' => 'btn btn-danger']
            ) ?>
        </div>
    </div>
</div>
