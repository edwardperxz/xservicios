    ...
    <div class="form-card">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('nombre', ['class' => 'form-input', 'label' => false, 'placeholder' => 'ej: Tour a Bocas del Toro', 'required' => true]) ?>
                <span class="form-help">Nombre descriptivo del servicio</span>
            </div>
            <div class="form-group">
