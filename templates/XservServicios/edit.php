...
$this->assign('header-title', 'Editar Servicio');
?>
...
<style>
    ...
    @media (max-width: 480px) {
        ...
        .form-actions-left, .form-actions-right { gap: 0.5rem; }
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Modifique la información del servicio (campos marcados con * son obligatorios)</p>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <span class="form-help">Nombre descriptivo que verán los clientes</span>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <span class="form-help">Los clientes solo verán servicios activos</span>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?= $this->Form->control('variantes', ['type' => 'textarea', 'id' => 'variantes-input', 'class' => 'form-textarea', 'label' => false, 'placeholder' => 'privado, compartido, VIP, económico', 'rows' => 4]) ?>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Servicio', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
        ...
        <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--dark-lighter, #2a2a2a);">
            <?= $this->Form->postLink(
                ...
                ['confirm' => '¿Está seguro que desea eliminar este servicio? Esta acción no se puede deshacer.', 'class' => 'btn btn-danger']
            ) ?>
        </div>
    </div>
</div>
