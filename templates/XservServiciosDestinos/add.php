 ...
 */
$this->assign('header-title', 'Nuevo Servicio-Destino');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Asociar Servicio con Destino</h2>
            <p class="form-subtitle">Vincule un servicio con un destino turístico y defina el orden de visita</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Asociación', ['class' => 'btn btn-primary']) ?>
        </div>
