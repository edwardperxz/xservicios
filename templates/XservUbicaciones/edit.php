...
$this->assign('header-title', 'Editar Ubicación');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Editar Ubicación</h2>
            <p class="form-subtitle">Modifique los datos de la ubicación geográfica</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Ubicación', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
