<?php
$this->assign('header-title', 'Detalle de Ubicación');
?>
...
<div class="view-container">
    <div class="view-card">
        <div class="view-header">
            <h2 class="view-title">Ubicación: <?= h($xservUbicacione->nombre) ?></h2>
            <div class="view-actions">
                <a href="<?= $this->Url->build(['action' => 'edit', $xservUbicacione->id]) ?>" class="btn btn-primary">Editar</a>
                <a href="<?= $this->Url->build(['action' => 'index']) ?>" class="btn btn-secondary">Volver al Listado</a>
                <?= $this->Form->postLink('Eliminar', ['action' => 'delete', $xservUbicacione->id], ['confirm' => '¿Está seguro?', 'class' => 'btn btn-danger']) ?>
            </div>
        </div>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value"><?= h($xservUbicacione->nombre) ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">En Provincias</div>
                <div class="detail-value"><?= h($xservUbicacione->EN_PROVINCIAS) ?></div>
            </div>
            <div class="detail-item" style="grid-column: 1 / -1;">
                <div class="detail-label">Dirección GPS</div>
                <div class="detail-value"><?= h($xservUbicacione->direccion_gps) ?></div>
            </div>
        </div>
    </div>
</div>