...
$this->assign('header-title', 'Nuevo Usuario');
?>

<style>
    /* Variables CSS por si no están definidas globalmente */
    :root {
        --gold: #c9a962;
        --gold-light: #d4b978;
        --dark-bg: #0a0a0a;
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Complete el formulario para crear un nuevo usuario del sistema</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Usuario', ['class' => 'btn btn-primary']) ?>
        </div>
