...
$this->assign('header-title', 'Editar Valoración');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Editar Valoración</h2>
            <p class="form-subtitle">Modifique la valoración del servicio</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <div class="form-actions-right">
                ...
                <?= $this->Form->button('Actualizar Valoración', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
        ...
        <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--dark-lighter, #2a2a2a);">
            <?= $this->Form->postLink(
                ...
                ['confirm' => '¿Está seguro de eliminar esta valoración? Esta acción no se puede deshacer.', 'class' => 'btn btn-danger']
            ) ?>
        </div>
    </div>
</div>
