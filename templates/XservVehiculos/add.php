...
$this->assign('header-title', 'Nuevo Vehículo');
?>
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">Nuevo Vehículo</h2>
            <p class="form-subtitle">Complete el formulario para agregar un nuevo vehículo a la flota</p>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button('Guardar Vehículo', ['class' => 'btn btn-primary']) ?>
        </div>
