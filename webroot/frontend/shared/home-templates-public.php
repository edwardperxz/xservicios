...
<head>
  ...
  <!-- Optimized Google Fonts: preconnect + lazy load -->
...
<body>
  ...
  <header class="header">
    ...
    <div class="header-right">
      ...
      <a href="/xserv-usuarios/login" class="btn-primary">Iniciar Sesión</a>
    </div>
  </header>
  ...
  <section class="cta-section">
    ...
    <div class="hero-actions" style="justify-content: center;">
      <a href="/newreservation" class="btn-primary">Reservar Ahora</a>
      <a href="https://wa.me/507XXXXXXXXXXXX" class="btn-secondary" target="_blank">Hablar con Soporte</a>
    </div>
  </section>
</body>
</html>
