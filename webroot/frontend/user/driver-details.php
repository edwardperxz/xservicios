      ...
      <div class="ficha-inner">
          ...
          <div class="ficha-logo">
            <div>
              <div class="ficha-logo-text">
                <span class="ficha-logo-x">X</span><span class="ficha-logo-servicios">SERVICIOS</span>
              </div>
              <div class="ficha-subtitle">Credencial de Conductor</div>
            </div>
          </div>
          <span class="ficha-badge badge-senior">Chofer Senior</span>
        </div>
        ...
        <div class="ficha-content">
          ...
          <div class="ficha-details">
            <h3 class="ficha-name">Carlos Mendoza Rivera</h3>
            
            <div class="ficha-row">
              <span class="ficha-label">Edad:</span>
              <span class="ficha-value">52 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Categoría:</span>
              <span class="ficha-value highlight">Chofer Senior</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Experiencia:</span>
              <span class="ficha-value highlight">18 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Licencia:</span>
              <span class="ficha-value">Tipo E - Profesional</span>
            </div>

            <div class="ficha-row">
              <span class="ficha-label">Unidad Asig.:</span>
              <span class="ficha-value">Coaster Toyota 2019</span>
            </div>
        ...
        <div class="ficha-footer">
          ...
          <span class="ficha-id">ID: CHF-2007-001</span>
        </div>
      </div>
    </div>

    <!-- Ficha Chofer 2 - Experimentado -->
    <div class="ficha-card">
      <div class="ficha-inner">
        <div class="ficha-header">
          <div class="ficha-logo">
          ...
          <span class="ficha-badge badge-experimentado">Experimentado</span>
        </div>
        ...
        <div class="ficha-content">
          ...
          <div class="ficha-details">
            <h3 class="ficha-name">Roberto Castillo Vargas</h3>
            
            <div class="ficha-row">
              <span class="ficha-label">Edad:</span>
              <span class="ficha-value">41 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Categoría:</span>
              <span class="ficha-value highlight">Experimentado</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Experiencia:</span>
              <span class="ficha-value highlight">12 años</span>
            </div>
            ...
            <div class="ficha-row">
              <span class="ficha-label">Unidad Asig.:</span>
              <span class="ficha-value">Minibus Mercedes 2021</span>
            </div>
        ...
        <div class="ficha-footer">
          ...
          <span class="ficha-id">ID: CHF-2013-015</span>
        </div>
      </div>
    </div>

    <!-- Ficha Chofer 3 - Profesional -->
    <div class="ficha-card">
      <div class="ficha-inner">
        <div class="ficha-header">
          <div class="ficha-logo">
          ...
          <span class="ficha-badge badge-profesional">Profesional</span>
        </div>
        ...
        <div class="ficha-content">
          ...
          <div class="ficha-details">
            <h3 class="ficha-name">Miguel Ángel Torres</h3>
            
            <div class="ficha-row">
              <span class="ficha-label">Edad:</span>
              <span class="ficha-value">35 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Categoría:</span>
              <span class="ficha-value highlight">Profesional</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Experiencia:</span>
              <span class="ficha-value highlight">7 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Licencia:</span>
              <span class="ficha-value">Tipo D - Comercial</span>
            </div>

            <div class="ficha-row">
              <span class="ficha-label">Unidad Asig.:</span>
              <span class="ficha-value">Coaster Hyundai 2020</span>
            </div>
        ...
        <div class="ficha-footer">
          ...
          <span class="ficha-id">ID: CHF-2018-042</span>
        </div>
      </div>
    </div>

    <!-- Ficha Chofer 4 - Junior -->
    <div class="ficha-card">
      <div class="ficha-inner">
        <div class="ficha-header">
          <div class="ficha-logo">
          ...
          <span class="ficha-badge badge-junior">Chofer Junior</span>
        </div>
        ...
        <div class="ficha-content">
          ...
          <div class="ficha-details">
            <h3 class="ficha-name">David Hernández López</h3>
            
            <div class="ficha-row">
              <span class="ficha-label">Edad:</span>
              <span class="ficha-value">28 años</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Categoría:</span>
              <span class="ficha-value highlight">Chofer Junior</span>
            </div>
            
            <div class="ficha-row">
              <span class="ficha-label">Experiencia:</span>
              <span class="ficha-value highlight">2 años</span>
            </div>
            ...
            <div class="ficha-row">
              <span class="ficha-label">Unidad Asig.:</span>
              <span class="ficha-value">Minibus Hyundai 2022</span>
            </div>
            ...
            <div class="rating-section">
              ...
              <div class="rating-stars">
                ...
                <svg class="star star-filled" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                <svg class="star star-filled" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                <svg class="star star-empty" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
              </div>
        ...
        <div class="ficha-footer">
          <div class="ficha-status">
            ...
            <span class="status-text">En vacaciones</span>
          </div>
          <span class="ficha-id">ID: CHF-2023-089</span>
        </div>
      </div>
    </div>
