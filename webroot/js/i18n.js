...
const translations = {
  es: {
    ...
    'profile.back': 'Volver',
    'profile.infoSection.alwaysPunctual': 'Siempre Puntuales',
    'profile.infoSection.safe': '100% Seguro',
    'profile.infoSection.premiumService': 'Servicio Premium',
    'profile.infoSection.satisfiedCustomers': 'Clientes Satisfechos',
    'profile.edit.title': 'Editar Mi Perfil',
    'profile.edit.subtitle': 'Gestiona tu información personal y de contacto',
    'profile.edit.personalInfo': 'Información Personal',
    'profile.edit.fullName': 'Nombre Completo',
    'profile.edit.fullNamePlaceholder': 'Ej: Juan Carlos Pérez',
    'profile.edit.fullNameHelp': 'Tu nombre completo',
    'profile.edit.username': 'Usuario',
    'profile.edit.usernamePlaceholder': 'Ej: juancperez',
    'profile.edit.usernameHelp': 'Tu nombre de usuario único',
    'profile.edit.contactInfo': 'Información de Contacto',
    'profile.edit.email': 'Correo Electrónico',
    'profile.edit.emailPlaceholder': 'Ej: juan@ejemplo.com',
    'profile.edit.emailHelp': 'Tu correo electrónico de contacto',
    'profile.edit.phone': 'Teléfono',
    'profile.edit.phonePlaceholder': 'Ej: +507 6000 0000',
    'profile.edit.phoneHelp': 'Tu número para contacto directo',
    'profile.edit.address': 'Dirección',
    'profile.edit.addressPlaceholder': 'Ej: Calle Principal 123',
    'profile.edit.city': 'Ciudad',
    'profile.edit.cityPlaceholder': 'Ej: Panamá',
    'profile.edit.state': 'Provincia',
    'profile.edit.statePlaceholder': 'Ej: Panamá Oeste',
    'profile.edit.zipCode': 'Código Postal',
    'profile.edit.zipCodePlaceholder': 'Ej: 00000',
    'profile.edit.country': 'País',
    'profile.edit.countryPlaceholder': 'Ej: Panamá',
    'profile.edit.countryDefault': 'Panamá',
    ...
    'services.detailIntro': 'Información detallada sobre el servicio',
    'services.reserveTitle': 'Reserva este servicio',
    'services.reserveText': 'Acepta los terminos y condiciones para solicitar tu reserva.',
    'services.customizeTitle': 'Personaliza tu servicio',
    'services.customizeText': 'Cuéntanos cambios de ruta, variantes o condiciones especiales. Te enviamos una propuesta a medida.',
    'btn.backServices': 'Volver a Servicios',

    
    // Service Detail
    'service.basePrice': 'Precio base',
    'service.status': 'Estado',
    'service.active': 'Disponible',
    'service.inactive': 'No disponible',
    ...
    'fleet.vehicleTitle': 'Flota <span>Vehicular</span>',
    ...
    'fleet.noPicture': 'Sin foto',
    'fleet.since': 'Desde',
    'fleet.noDrivers': 'No hay choferes disponibles',
    'fleet.viewMore': 'Ver más',
    'fleet.alwaysPunctual': 'Siempre Puntuales',
    'fleet.safe': '100% Seguro',
    'fleet.premiumService': 'Servicio Premium',
    'fleet.satisfiedCustomers': 'Clientes Satisfechos',
  ...
  en: {
    ...
    'profile.back': 'Back',
    'profile.infoSection.alwaysPunctual': 'Always Punctual',
    'profile.infoSection.safe': '100% Safe',
    'profile.infoSection.premiumService': 'Premium Service',
    'profile.infoSection.satisfiedCustomers': 'Satisfied Customers',
    'profile.edit.title': 'Edit My Profile',
    'profile.edit.subtitle': 'Manage your personal and contact information',
    'profile.edit.personalInfo': 'Personal Information',
    'profile.edit.fullName': 'Full Name',
    'profile.edit.fullNamePlaceholder': 'E.g: John Carlos Perez',
    'profile.edit.fullNameHelp': 'Your full name',
    'profile.edit.username': 'Username',
    'profile.edit.usernamePlaceholder': 'E.g: johnperez',
    'profile.edit.usernameHelp': 'Your unique username',
    'profile.edit.contactInfo': 'Contact Information',
    'profile.edit.email': 'Email Address',
    'profile.edit.emailPlaceholder': 'E.g: john@example.com',
    'profile.edit.emailHelp': 'Your contact email',
    'profile.edit.phone': 'Phone',
    'profile.edit.phonePlaceholder': 'E.g: +507 6000 0000',
    'profile.edit.phoneHelp': 'Your phone number for direct contact',
    'profile.edit.address': 'Address',
    'profile.edit.addressPlaceholder': 'E.g: Main Street 123',
    'profile.edit.city': 'City',
    'profile.edit.cityPlaceholder': 'E.g: Panama',
    'profile.edit.state': 'Province',
    'profile.edit.statePlaceholder': 'E.g: Panama West',
    'profile.edit.zipCode': 'Postal Code',
    'profile.edit.zipCodePlaceholder': 'E.g: 00000',
    'profile.edit.country': 'Country',
    'profile.edit.countryPlaceholder': 'E.g: Panama',
    'profile.edit.countryDefault': 'Panama',
    ...
    'services.detailIntro': 'Detailed information about the service',
    'services.reserveTitle': 'Reserve this service',
    'services.reserveText': 'Accept the terms and conditions to request your reservation.',
    'services.customizeTitle': 'Customize your service',
    'services.customizeText': 'Tell us about route changes, variants or special conditions. We send you a tailor-made proposal.',
    'btn.backServices': 'Back to Services',
    
    // Service Detail
    'service.basePrice': 'Base price',
    'service.status': 'Status',
    'service.active': 'Available',
    'service.inactive': 'Unvailable',
    ...
    'fleet.noPicture': 'No photo',
    'fleet.since': 'Since',
    'fleet.noDrivers': 'No drivers available',
    'fleet.viewMore': 'View More',
    'fleet.alwaysPunctual': 'Always Punctual',
    'fleet.safe': '100% Safe',
    'fleet.premiumService': 'Premium Service',
    'fleet.satisfiedCustomers': 'Satisfied Customers',
